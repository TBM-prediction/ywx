...
class DataFormatter:
    def __init__(self, fns):
        ...
        with concurrent.futures.ThreadPoolExecutor() as e:
            ...
            df_raw = list(tqdm_notebook(e.map(f, fns)))
    ...
    def cleanup(self, min_num_zeros = 5):
        ...
        with concurrent.futures.ThreadPoolExecutor(16) as e:
            ft = e.map(f, begins, ends, num_zeros)
            list(tqdm_notebook(ft, total=len(begins)))
    ...
    def cycles1(self):
        ...
        [o.reset_index(drop=True, inplace=True) for o in self.cycles]
